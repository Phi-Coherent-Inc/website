/*! UPNG.js — Photopea PNG codec. MIT License. https://github.com/photopea/UPNG.js
 *  Vendored for the φCoherent image-codec demo to produce an OPTIMIZED, LOSSLESS
 *  PNG baseline (adaptive per-row filtering + deflate) for the φ-vs-PNG size
 *  comparison. Requires pako (loaded first as window.pako). cnum=0 => lossless.
 */
